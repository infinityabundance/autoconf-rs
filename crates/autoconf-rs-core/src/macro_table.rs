...
impl MacroTable {
    ...
    fn register_builtins(&mut self) {
        let builtins: &[(&str, &str)] = &[
            ...
            ("AC_WARNING", ""),
            ("AC_FATAL", ""),
            // Aliases + Automake/libtool macros: recognized so they are consumed (no literal
            // leftover -> shell syntax error). Their AC_SUBST surface is defaulted by config.status.
            ("AC_CONFIG_HEADER", ""),
            ("AC_CONFIG_MACRO_DIR", ""),
