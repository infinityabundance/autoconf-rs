...
# Generated by GNU Autoconf 2.73 for {NAME} {VERSION}.
#
#
...
# in other old shells (e.g. bash {VERSION}1 and pdksh 5.2.14).
...
if (echo >conf$$.file) 2>/dev/null; then
  if ln -s conf$$.file conf$$ 2>/dev/null; then
    ...
    # 2) DJGPP < {VERSION}4 has no symlinks; 'ln -s' creates a wrapper executable.
...
printf '%s\n' "#define PACKAGE \"{NAME}\"" >>confdefs.h
...
ac_log="
This file was extended by {NAME} $as_me {VERSION}, which was
generated by GNU Autoconf 2.73.  Invocation command line was
