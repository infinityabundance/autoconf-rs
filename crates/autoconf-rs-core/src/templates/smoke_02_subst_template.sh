...
# Generated by GNU Autoconf 2.73 for subst_test 1.0.
#
#
...
PACKAGE_NAME='subst_test'
PACKAGE_TARNAME='subst_test'
PACKAGE_VERSION='1.0'
PACKAGE_STRING='subst_test 1.0'
PACKAGE_BUGREPORT=''
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures subst_test 1.0 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/subst_test]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of subst_test 1.0:";;
   esac
  cat <<\_ACEOF
...
It was created by subst_test $as_me 1.0, which was
...
ac_log="
This file was extended by subst_test $as_me 1.0, which was
generated by GNU Autoconf 2.73.  Invocation command line was
