...
# Generated by GNU Autoconf 2.73 for libfuncs 2.0.
#
...
then :
  ...
  if test ${ZSH_VERSION+y} ; then
    ...
    printf '%s\n' "$0: Please tell bug-autoconf@gnu.org and bugs@example.com
...
PACKAGE_NAME='libfuncs'
PACKAGE_TARNAME='libfuncs'
PACKAGE_VERSION='2.0'
PACKAGE_STRING='libfuncs 2.0'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures libfuncs 2.0 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/libfuncs]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of libfuncs 2.0:";;
   esac
  cat <<\_ACEOF
...
It was created by libfuncs $as_me 2.0, which was
...
ac_fn_check_decl "$LINENO" "strerror_r" "ac_cv_have_decl_strerror_r" "$ac_includes_default" "$ac_c_undeclared_builtin_options$ac_c_future_darwin_options" "CFLAGS"
...
ac_log="
This file was extended by libfuncs $as_me 2.0, which was
generated by GNU Autoconf 2.73.  Invocation command line was
