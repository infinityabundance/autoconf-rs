...
# Generated by GNU Autoconf 2.73 for smoke 0.1.
#
#
...
PACKAGE_NAME='smoke'
PACKAGE_TARNAME='smoke'
PACKAGE_VERSION='0.1'
PACKAGE_STRING='smoke 0.1'
PACKAGE_BUGREPORT=''
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures smoke 0.1 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/smoke]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of smoke 0.1:";;
   esac
  cat <<\_ACEOF
...
It was created by smoke $as_me 0.1, which was
...
ac_log="
This file was extended by smoke $as_me 0.1, which was
generated by GNU Autoconf 2.73.  Invocation command line was
