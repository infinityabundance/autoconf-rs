...
# Generated by GNU Autoconf 2.73 for header_test 2.0.
#
#
...
PACKAGE_NAME='header_test'
PACKAGE_TARNAME='header_test'
PACKAGE_VERSION='2.0'
PACKAGE_STRING='header_test 2.0'
PACKAGE_BUGREPORT=''
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures header_test 2.0 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/header_test]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of header_test 2.0:";;
   esac
  cat <<\_ACEOF
...
It was created by header_test $as_me 2.0, which was
...
printf '%s\n' "#define PACKAGE \"header_test\"" >>confdefs.h

printf '%s\n' "#define VERSION \"2.0\"" >>confdefs.h
...
ac_log="
This file was extended by header_test $as_me 2.0, which was
generated by GNU Autoconf 2.73.  Invocation command line was
