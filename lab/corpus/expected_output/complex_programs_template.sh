...
# Generated by GNU Autoconf 2.73 for grep-prog 1.0.
#
# Report bugs to <bug-grep@example.com>.
#
#
...
$0: bug-grep@example.com about your system, including any
...
PACKAGE_NAME='grep-prog'
PACKAGE_TARNAME='grep-prog'
PACKAGE_VERSION='1.0'
PACKAGE_STRING='grep-prog 1.0'
PACKAGE_BUGREPORT='bug-grep@example.com'
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures grep-prog 1.0 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/grep-prog]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of grep-prog 1.0:";;
   esac
  cat <<\_ACEOF
...
It was created by grep-prog $as_me 1.0, which was
...
{ printf '%s\n' "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
printf %s "checking for $ac_word... " >&6; }
if test ${ac_cv_prog_HAVE_PERL+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) if test -n "$HAVE_PERL"; then
...
if test -n "$HAVE_PERL"; then
  { printf '%s\n' "$as_me:${as_lineno-$LINENO}: result: $HAVE_PERL" >&5
printf '%s\n' "$HAVE_PERL" >&6; }
else
  { printf '%s\n' "$as_me:${as_lineno-$LINENO}: result: no" >&5
printf '%s\n' "no" >&6; }
...
if test ${with_libpcre+y}
then :
  withval=$with_libpcre;
fi

{ printf '%s\n' "$as_me:${as_lineno-$LINENO}: checking for working environment" >&5
printf %s "checking for working environment... " >&6; }
...
ac_log="
This file was extended by grep-prog $as_me 1.0, which was
generated by GNU Autoconf 2.73.  Invocation command line was
