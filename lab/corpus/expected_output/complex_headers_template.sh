...
# Generated by GNU Autoconf 2.73 for libtypes 3.1.
#
...
then :
  ...
  if test ${ZSH_VERSION+y} ; then
    ...
    printf '%s\n' "$0: Please tell bug-autoconf@gnu.org and dev@example.com
...
PACKAGE_NAME='libtypes'
PACKAGE_TARNAME='libtypes'
PACKAGE_VERSION='3.1'
PACKAGE_STRING='libtypes 3.1'
PACKAGE_BUGREPORT='dev@example.com'
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures libtypes 3.1 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/libtypes]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of libtypes 3.1:";;
   esac
  cat <<\_ACEOF
...
It was created by libtypes $as_me 3.1, which was
...
ac_log="
This file was extended by libtypes $as_me 3.1, which was
generated by GNU Autoconf 2.73.  Invocation command line was
